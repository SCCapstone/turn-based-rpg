function weapons_map(){
	...
	global.weapons_map[? "_sword"] = _item;
	...
	global.weapons_map[? "_scythe"] = _item;
  ...
  var _item = ds_map_create();
	...
	_item[? "_description"] = "";
	global.weapons_map[? "_nothing"] = _item;
  ...
  var _item = ds_map_create();
	...
	global.weapons_map[? "_dagger"] = _item;
	...
	global.weapons_map[? "_greatsword"] = _item;
	...
	global.weapons_map[? "_halberd"] = _item;
  ...
  var _item = ds_map_create();
	...
	global.weapons_map[? "_spear"] = _item;
  ...
  var _item = ds_map_create();
	...
	global.weapons_map[? "_warhammer"] = _item;
  ...
  var _item = ds_map_create();
	...
	global.weapons_map[? "_battleaxe"] = _item;
  ...
  var _item = ds_map_create();
	...
	_item[? "_type"] = damage_source.melee;
	_item[? "_description"] = "";
	global.weapons_map[? "_fangs"] = _item;
}