...
if (global.inventory[# _x_pos, _y_pos] != noone) {
	...
	if (_show_tooltip) {
			...
			draw_sprite_stretched(spr_menu_background, 0, x + 33 + (_x_pos * 30), y + 75 + (_y_pos * 30), _tooltip_width, _tooltip_height);
			...
			draw_sprite_stretched(spr_menu_background, 0, x + 15 + (_x_pos * 30) - _tooltip_width, y + 75 + (_y_pos * 30), _tooltip_width, _tooltip_height);
			...
			draw_sprite_stretched(spr_menu_background, 0, x + 33 + (_x_pos * 30), y + 58 + (_y_pos * 30) - _tooltip_height, _tooltip_width, _tooltip_height);
			...
			draw_sprite_stretched(spr_menu_background, 0, x + 15 + (_x_pos * 30) - _tooltip_width, y + 58 + (_y_pos * 30) - _tooltip_height, _tooltip_width, _tooltip_height);
