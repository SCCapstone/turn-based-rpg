...
if (pos2 = 0) {
	...
	if (pos = 5) {
		...
		draw_text_ext_transformed_color(stat_description_x, stat_info_y + 75, "Speed: Determines battle order.", op_space, op_margin, text_size - .02, text_size - .02, 0, c_white, c_white, c_white, c_white, 1);
	} else {
	...
	if (pos = 5) {
		draw_text_ext_transformed_color(stat_info_x, stat_info_y + 75, "SPD: " + string(global.party[1]._spd), op_space, op_margin, text_size, text_size, 0, c_yellow, c_yellow, c_yellow, c_yellow, 1);
		draw_text_ext_transformed_color(stat_description_x, stat_info_y + 75, "Speed: Determines battle order.", op_space, op_margin, text_size - .02, text_size - .02, 0, c_white, c_white, c_white, c_white, 1);
	} else {
		draw_text_ext_transformed_color(stat_info_x, stat_info_y + 75, "SPD: " + string(global.party[1]._spd), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
	}
}
