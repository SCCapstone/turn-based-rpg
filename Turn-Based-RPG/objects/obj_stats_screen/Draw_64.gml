...
draw_sprite_stretched(spr_stat_party, 0, 220, 45, 80, 25);
draw_text_ext_transformed_color(225, 50, string(ds_list_find_value(global.party,0)._name), op_space, op_margin, text_size - .03, text_size -.03, 0, c_white, c_white, c_white,c_white, 1)
