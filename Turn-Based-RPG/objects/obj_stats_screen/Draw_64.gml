...
if (!party_disable) {
	...
	draw_text_ext_transformed_color(250, 50, string(ds_list_find_value(global.party,0)._name), op_space, op_margin, text_size - .03, text_size -.03, 0, c_white, c_white, c_white,c_white, 1);
	draw_text_ext_transformed_color(290, 50,"Lvl: " + string(ds_list_find_value(global.party,0)._lvl), op_space,op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
	draw_sprite_part_ext(spr_icon1, 0, 4, 0, 8, 10, 235, 51, 1.2, 1.2, c_white, 1);
	draw_text_ext_transformed_color(255, 58, string(ds_list_find_value(global.party,0)._hp) + "/" + string(ds_list_find_value(global.party,0)._max_hp), op_space, op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
	if (ds_list_size(global.party) == 2) {
		...
		draw_text_ext_transformed_color(250, 80, string(ds_list_find_value(global.party,1)._name), op_space, op_margin, text_size - .03, text_size -.03, 0, c_white, c_white, c_white,c_white, 1);
		draw_text_ext_transformed_color(290, 80,"Lvl: " + string(ds_list_find_value(global.party,1)._lvl), op_space,op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
		draw_sprite_part_ext(spr_icon2, 0, 4, 0, 8, 10, 235, 81, 1.2, 1.2, c_white, 1);
		draw_text_ext_transformed_color(255, 88, string(ds_list_find_value(global.party,1)._hp) + "/" + string(ds_list_find_value(global.party,1)._max_hp), op_space, op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
	}
	if (ds_list_size(global.party) == 3) {
		...
		draw_text_ext_transformed_color(250, 110, string(ds_list_find_value(global.party,2)._name), op_space, op_margin, text_size - .03, text_size -.03, 0, c_white, c_white, c_white,c_white, 1);
		draw_text_ext_transformed_color(290, 110,"Lvl: " + string(ds_list_find_value(global.party,2)._lvl), op_space,op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
		draw_sprite_part_ext(spr_icon3, 0, 4, 0, 8, 10, 235, 111, 1.2, 1.2, c_white, 1);
		draw_text_ext_transformed_color(255, 118, string(ds_list_find_value(global.party,2)._hp) + "/" + string(ds_list_find_value(global.party,2)._max_hp), op_space, op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
	}
	if (ds_list_size(global.party) == 4) {
		...
		draw_text_ext_transformed_color(250, 140, string(ds_list_find_value(global.party,3)._name), op_space, op_margin, text_size - .03, text_size -.03, 0, c_white, c_white, c_white,c_white, 1);
		draw_text_ext_transformed_color(290, 140,"Lvl: " + string(ds_list_find_value(global.party,3)._lvl), op_space,op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
		draw_sprite_part_ext(spr_icon4, 0, 4, 0, 8, 10, 235, 141, 1.2, 1.2, c_white, 1);
		draw_text_ext_transformed_color(255, 148, string(ds_list_find_value(global.party,3)._hp) + "/" + string(ds_list_find_value(global.party,3)._max_hp), op_space, op_margin, text_size - .03, text_size - .03, 0, c_white, c_white, c_white, c_white, 1);
	}
	...
	draw_text_ext_transformed_color(stat_info_x, stat_info_y + 105, "STAT POINTS: " + string(skill_points[0]), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
		...
		draw_text_ext_transformed_color(stat_info_x + 100, stat_info_y - 40, string(ds_list_find_value(global.party,2)._name) + " Lvl: " + string(ds_list_find_value(global.party,2)._lvl), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
		draw_text_ext_transformed_color(stat_info_x + 110, stat_info_y - 25, "XP: " + string(ds_list_find_value(global.party,2)._xp) + " / " + string(ds_list_find_value(global.party,2)._max_xp), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
		if (statpos = 0) {
		...
		draw_text_ext_transformed_color(stat_info_x + 100, stat_info_y - 40, string(ds_list_find_value(global.party,3)._name) + " Lvl: " + string(ds_list_find_value(global.party,3)._lvl), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
		draw_text_ext_transformed_color(stat_info_x + 110, stat_info_y - 25, "XP: " + string(ds_list_find_value(global.party,3)._xp) + " / " + string(ds_list_find_value(global.party,3)._max_xp), op_space, op_margin, text_size, text_size, 0, c_white, c_white, c_white, c_white, 1);
		if (statpos = 0) {
